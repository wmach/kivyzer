...
USER ${USER}
WORKDIR ${WORK_DIR}
RUN chown kivyzer:kivyzer ${WORK_DIR}
# COPY --chown=kivyzer:kivyzer . ${SRC_DIR}
COPY --chown=kivyzer:kivyzer requirements.txt requirements.txt

# installs buildozer and dependencies
RUN pip3 install --user --upgrade Cython==0.29.33 wheel pip virtualenv
# RUN pip3 install --user --upgrade Cython==0.29.33 wheel pip virtualenv -t ${SRC_DIR}
